...
<body class="font-inter bg-white antialiased">
    <nav class="fixed top-0 w-full z-50 glass transition-all duration-300">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-18 py-4">
            <a href="/" class="inline-flex items-center gap-3">
                <img src="{{ asset('images/logo.png') }}" alt="GenDer Lab Logo" class="h-20 w-auto transition duration-300">
            </a>
            <div class="hidden md:flex items-center gap-8">
                <a href="#services" class="text-white/70 hover:text-white text-sm font-medium transition">Services</a>
                <a href="#how" class="text-white/70 hover:text-white text-sm font-medium transition">Processus</a>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('register') }}" class="bg-bio-500 hover:bg-bio-400 text-white font-bold text-sm px-5 py-2.5 rounded-xl transition shadow-lg shadow-bio-500/30">S'inscrire</a>
            </div>
        </div>
    </nav>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <p class="text-slate-200 text-base lg:text-lg leading-relaxed mb-10 max-w-2xl font-medium">
                        Analyse génétique dédiée aux oiseaux et volailles. Séquençage PCR, IA électrophorèse et rapport certifié livrés en 24-72h.
                    </p>
                ...
                <div class="relative">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-[0_45px_120px_-50px_rgba(0,0,0,0.7)] border border-white/10 bg-slate-950/80 backdrop-blur-xl">
                        <img src="{{ asset('images/bird_hero.png') }}" alt="Sexage ADN" class="w-full h-[560px] object-cover" style="min-height: 560px;">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-950/80 via-transparent to-transparent"></div>
                        <div class="absolute left-6 bottom-6 p-5 rounded-3xl bg-slate-900/80 border border-white/10 shadow-xl">
    ...
    <section id="services" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="inline-flex items-center gap-2 bg-bio-100 text-bio-700 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-4 border border-bio-200">Nos services</span>
    ...
    <section id="how" class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-bio-500 font-bold text-xs uppercase tracking-widest mb-3 inline-block">Processus simplifié</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <img src="{{ asset('images/how_it_works.png') }}" alt="Processus GenDer Lab" class="rounded-[2rem] shadow-[0_30px_80px_-40px_rgba(15,23,42,0.2)] w-full">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gradient-to-r from-bio-950 via-slate-900 to-indigo-950 text-white relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
            <h2 class="font-outfit font-black text-4xl lg:text-5xl mb-6 tracking-tight">Rejoignez les éleveurs qui nous font confiance</h2>
            <p class="text-slate-300 text-lg mb-10 leading-relaxed">Créez votre compte, suivez vos prélèvements et recevez des rapports validés. La première étape vers un élevage plus sûr commence ici.</p>
            <a href="{{ route('register') }}" class="inline-flex items-center gap-3 bg-bio-500 hover:bg-bio-400 text-slate-950 font-bold text-sm uppercase py-4 px-10 rounded-3xl shadow-xl shadow-bio-500/30 transition hover:-translate-y-1">Créer mon compte</a>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-slate-400 text-sm">
                        <li class="flex items-center gap-2"><span class="text-bio-400">•</span> contact@bioscan-ai.com</li>
                        <li class="flex items-center gap-2"><span class="text-bio-400">•</span> +213 XX XX XX XX</li>
                        <li class="flex items-center gap-2"><span class="text-bio-400">•</span> Support 24/7</li>
                    </ul>
                </div>
            </div>
